...
| | |
|---|---|
| 🥇 **AI for Vizag Buildathon 2026** | 1st Prize — Ratan Tata Innovation Hub, sponsored by FluentGrid |
| 🥇 **ZigmaNeural AI Buildathon 2025** | 1st Prize — Team CrossStack |
| 🤖 **Quantum ML · Fintech** | 93% accuracy fraud detection system (Qiskit) |
| 🧬 **ML · Oncology** | 92.73% chemotherapy response prediction on 1,100 patient samples |
| 🎓 **ALTA AI Builders Fellowship** | Accepted — currently building an AI Product Recommendation Agent |
| 👨‍💻 **Developers Club Lead · NSRIT** | Mentoring juniors and organizing tech events |
